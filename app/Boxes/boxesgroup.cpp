...
void BoxesGroup::filterOutlinePathBeforeThickness(
...
void BoxesGroup::filterOutlinePath(const qreal &relFrame,
                                   SkPath * const srcDstPath) {
...
void BoxesGroup::filterFillPath(const qreal &relFrame,
                                SkPath * const srcDstPath) {

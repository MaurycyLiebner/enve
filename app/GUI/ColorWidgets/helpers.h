...
extern void hsv_to_hsl(const float &h, float &s, float &v);
extern void hsl_to_hsv(const float &h, float &s, float &l);
...
extern void qhsv_to_hsl(const qreal &h, qreal &s, qreal &v);
extern void qhsl_to_hsv(const qreal &h, qreal &s, qreal &l);

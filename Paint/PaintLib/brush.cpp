...
BrushSettingInfo Brush::brush_settings_info[BRUSH_SETTINGS_COUNT] = {
        ...
        BrushSettingInfo(BRUSH_SETTING_ALPHA, 0.f, 1.f, 0.5f, "alpha"),
...
qreal *Brush::getSettingValuePointer(BrushSetting setting_t)
{
    ...
    else if(setting_t == BRUSH_SETTING_ALPHA)
    {
        return &alpha;
    }
...
qreal Brush::getDistBetweenDabs()
{
    return distance_between_dabs;
}

qreal Brush::getDistBetweenDabsPx()
{
...
QString Brush::getSettingAsFileLine(BrushSetting setting_t)
{
...
QString Brush::getBrushName()
{
    return brush_name;
}

QString Brush::getCollectionName()
{
    return collection_name;
}

QString Brush::getBrushFilePath()
{
    return brush_file_path;
}

qreal Brush::getSettingVal(BrushSetting setting_t)
{
    return *getSettingValuePointer(setting_t);
}
...
void Brush::getRGBA(qreal *red_t, qreal *green_t, qreal *blue_t, qreal *alpha_t)
{
    *red_t = red;
    *green_t = green;
    *blue_t = blue;
...
void Brush::getHSV(qreal *h_t, qreal *s_t, qreal *v_t)
{
    *h_t = h;
    *s_t = s;
    *v_t = v;
...
qreal Brush::getHardness()
{
    return hardness;
}

qreal Brush::getOpacity()
{
    return opacity;
}

qreal Brush::getRadius()
{
    return radius;
}

qreal Brush::getAspectRatio()
{
    return aspect_ratio;
}

qreal Brush::getColorPickUp()
{
    return color_pick_up;
}

qreal Brush::getColorPickUpDecay()
{
    return color_decay;
}

qreal Brush::getInitialRotation()
{
    return initial_rotation;
}

qreal Brush::getRotationInfluence()
{
    return rotation_influence;
}

qreal Brush::getRotationDelay()
{
    return rotation_delay;
}

qreal Brush::getRotationNoise()
{
    return rotation_noise;
}

qreal Brush::getRotationNoiseFrequency()
{
    return rotation_noise_frequency;
}

qreal Brush::getDabPositionNoisePx()
{
    return dab_position_noise*radius;
}

qreal Brush::getStrokePositionNoisePx()
{
    return stroke_position_noise*radius;
}

qreal Brush::getStrokePositionNoiseFrequency()
{
    return stroke_position_noise_frequency;
}

qreal Brush::getHueNoise()
{
    return hue_noise;
}

qreal Brush::getHueNoiseFrequency()
{
    return hue_noise_frequency;
}

qreal Brush::getValueNoise()
{
    return value_noise;
}

qreal Brush::getValueNoiseFrequency()
{
    return value_noise_frequency;
}

qreal Brush::getSaturationNoise()
{
    return saturation_noise;
}

qreal Brush::getSaturationNoiseFrequency()
{
    return saturation_noise_frequency;
}

qreal Brush::getRotationBetweenDabs()
{
    return rotation_between_dabs;
}

qreal Brush::getPressureRadiusGain()
{
    return pressure_radius_gain;
}
...
QString Brush::getStrokeBrushFilePath()
{
    return stroke_brush_file_path;
}

bool Brush::wasChangedSinceLastStroke()
{
...
qreal Brush::getPressureRadiusGainPx()
{
    return pressure_radius_gain*radius;
}

qreal Brush::getPressureOpacityGain()
{
    return pressure_opacity_gain;
}

qreal Brush::getPressureHardnessGain()
{
    return pressure_hardness_gain;
}

qreal Brush::getPressureAlphaGain()
{
    return pressure_alpha_gain;
}

qreal Brush::getPressureAspectRatioGain()
{
    return pressure_aspect_ratio_gain;
}

qreal Brush::getSpeedRadiusGain()
{
    return speed_radius_gain;
}

qreal Brush::getSpeedOpacityGain()
{
    return speed_opacity_gain;
}

qreal Brush::getSpeedHardnessGain()
{
    return speed_hardness_gain;
}

void Brush::getPickedUpRGBA(qreal *red_t, qreal *green_t, qreal *blue_t, qreal *alpha_t)
{
    *red_t = picked_up_red;
...
void Brush::addPickedUpRGBAFromNewStroke(qreal red_t, qreal green_t, qreal blue_t, qreal alpha_t)
{
    alpha_t *= color_pick_up;
    picked_up_alpha = picked_up_alpha*(1.f - color_decay);
...
void Brush::resetPickedUpRGBA()
{
    picked_up_red = red;
    picked_up_green = green;
    picked_up_blue = blue;
    picked_up_alpha = initial_alpha;
}
